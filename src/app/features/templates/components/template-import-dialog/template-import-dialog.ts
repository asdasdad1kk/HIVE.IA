...
export class TemplateImportDialogComponent
  ...
  async copyDebugPrompt(): Promise<void> {
    ...
    const prompt = [
      ...
      'IMPORTANTE: conserva el tipo de cada sección. Si view es action-plan, NO agregues fields y NO cambies view a form. Corrige la validación manteniendo phases e initialActions.',
      '',
      'ERRORES DETECTADOS:',
      ...issues.map(
        (issue, index) =>
  ...
  private buildActionPlanPrompt(request: string): string {
    return [
      ...
      '- Detecta cada proyecto, bloque, area, categoria o encabezado del Excel como una fase personalizada. Para PDCA usa plan/do/check/act; para DMAIC usa define/measure/analyze/improve/control; para FREE crea una fase por proyecto visible.',
      ...
      '',
      'ESQUEMA EXACTO:',
      '{"name":"...","description":"...","definition":{"sections":[{"id":"plan-accion","title":"...","view":"action-plan","methodology":"FREE|PDCA|DMAIC","involvedEmails":["correo@empresa.com"],"phases":[{"id":"proyecto-a","label":"Proyecto A","description":"..."}],"initialRows":0,"minimumRows":0,"maximumRows":100,"requireAction":true,"requireResponsible":true,"requireEcd":true,"initialActions":[]}]}}',
      '',
      'INITIAL ACTION:',
      '{"id":"accion-1","phaseId":"proyecto-a","action":"Texto completo","responsibleEmail":"correo@empresa.com","ecds":[{"label":"ECD1","date":"2026-09-30","completed":false}],"progress":25,"observations":"..."}',
      'SUBACTION:',
      '{"id":"accion-1-1","parentId":"accion-1","phaseId":"proyecto-a","action":"Subacción completa","responsibleEmail":"correo@empresa.com","ecds":[{"label":"ECD1","date":"","completed":false}],"progress":0,"observations":""}',
      '',
      ...
      '',
      'METODOLOGÍAS:',
      '- FREE: una fase personalizada por cada proyecto, bloque o frente visible. No uses fase general si existen nombres de proyectos.',
